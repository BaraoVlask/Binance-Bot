                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            @if ($dataTypeContent->{$row->field} instanceof \App\Models\DTO\FilterFields)
                                {{
                                collect($dataTypeContent->{$row->field}->fields)
                                    ->forget('filterType')
                                    ->mapWithKeys(
                                        fn($value, $key) => [
                                            \Illuminate\Support\Str::replace('_', ' ', \Illuminate\Support\Str::snake($key)) => $value
                                        ]
                                    )
                                }}
