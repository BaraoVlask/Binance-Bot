...
CREATE TABLE `account_reports` (
  ...
  `stream` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `account_reports_orders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `account_reports_orders` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `account_report_id` bigint unsigned NOT NULL,
  `order_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `account_reports_orders_account_report_id_foreign` (`account_report_id`),
  KEY `account_reports_orders_order_id_foreign` (`order_id`),
  CONSTRAINT `account_reports_orders_account_report_id_foreign` FOREIGN KEY (`account_report_id`) REFERENCES `account_reports` (`id`),
  CONSTRAINT `account_reports_orders_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `filters` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `filters_symbol_id_foreign` (`symbol_id`),
  CONSTRAINT `filters_symbol_id_foreign` FOREIGN KEY (`symbol_id`) REFERENCES `symbols` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `price_range_id` bigint unsigned NOT NULL,
  `binance_id` bigint unsigned DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `orders_binance_id_unique` (`binance_id`),
  KEY `orders_price_range_id_foreign` (`price_range_id`),
  CONSTRAINT `orders_price_range_id_foreign` FOREIGN KEY (`price_range_id`) REFERENCES `price_ranges` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `price_ranges` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `price_ranges_buy_price_unique` (`buy_price`),
  KEY `price_ranges_symbol_id_foreign` (`symbol_id`),
  CONSTRAINT `price_ranges_symbol_id_foreign` FOREIGN KEY (`symbol_id`) REFERENCES `symbols` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `symbols` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tick_size` double(8,8) NOT NULL,
  `round_length` tinyint NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` VALUES (27,'2018_08_08_100000_create_telescope_entries_table',1);
...
INSERT INTO `migrations` VALUES (30,'2023_02_15_024618_create_symbols_table',1);
INSERT INTO `migrations` VALUES (31,'2023_02_15_024703_create_symbol_filters_table',1);
INSERT INTO `migrations` VALUES (32,'2023_02_15_025643_create_price_ranges_table',1);
INSERT INTO `migrations` VALUES (33,'2023_02_15_033834_create_orders_table',1);
INSERT INTO `migrations` VALUES (34,'2023_02_15_035624_create_account_reports_table',1);
INSERT INTO `migrations` VALUES (35,'2023_02_15_160229_create_account_reports_orders_table',1);
INSERT INTO `migrations` VALUES (36,'2023_02_17_045845_create_jobs_table',1);
